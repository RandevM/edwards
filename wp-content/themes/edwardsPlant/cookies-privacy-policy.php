...
<p>Cookies allow us to do multiple things to enhance and improve your browsing experience on our website.</p>

<p>We use cookies to track visitors to our website; these details are in no way personal details and will never be shared. Using these cookies we can improve the performance of our website for you, the user.</p>

<p>We also use cookies in order to geo-target specific users to make websites more personal.</p>

<p>By using the website of <strong><?php echo $companyName ?></strong> you consent to the usage of data captured by the use of cookies. If you wish to turn off cookies, please adjust your browser settings. Our website will continue to function without cookies.</p>
...
<p>We use remarketing codes to log when users view specific pages, allowing us to provide targeted advertising in the future.</p>
...
<p>This is the website of <strong><?php echo $companyName ?></strong>.</p>

<p>Our postal address is:</p>

<p><?php echo $companyAddressStacked; ?></p>

<p>We can be reached via e-mail at <?php echo $companyEmail ?> or you can reach us by telephone at <span class="ld-phonenumber"><?php echo $phonenumber ?></span>.</p>

<p>For each visitor to our Web page, our Web server automatically recognises no information regarding the domain or e-mail address.</p>

<p>We collect the e-mail addresses of those who communicate with us via e-mail, name and address, telephone number.</p>
...
<p>Persons who supply us with their telephone numbers on-line will only receive telephone contact from us with information regarding enquiries placed on line.</p>
